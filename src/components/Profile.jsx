  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const dailyCountsResponse = await backendApiInstance.get(`${import.meta.env.VITE_BE_URL}/api/submission/daily/count`, {
          headers: {
        ...
        const submissionsResponse = await backendApiInstance.get(`${import.meta.env.VITE_BE_URL}/api/submission/`, {
          headers: {
            'Authorization': `Bearer ${token}`
          },
          params: {
